...
Width conditions:
	...
	if inc == 3:
		...
		wallL.setEuler(x=0, y=-90, z=0)
		wallL.texture(metal)
		planeL.setPosition([2.5, -13.75, 6])
		planeR.setPosition([1.25, -7.0, -6])
	...
	if inc == 4:
		...
		planeL.setPosition([1.25, -20.75, 6])
		planeR.setPosition([1.25, -7.0, -6])
		...
		planeL.setPosition([1.25, -7.0, 6])
		planeR.setPosition([1.25, -20.75, -6])
